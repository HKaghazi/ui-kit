...
export interface SidebarCollapseProps
  extends PropsWithChildren<ComponentProps<'button'> & SidebarItemProps> {
  open?: boolean
}
    ...
    <Wrapper>
      ...
      >
        {Icon && (
          <Icon
            ...
            className={classNames(
              theme.collapse.icon.base,
              theme.collapse.icon.open[isOpen ? 'on' : 'off']
            )}
        ...
        {isCollapsed ? (
          ...
          <>
            <span
              className={theme.collapse.label.base}
